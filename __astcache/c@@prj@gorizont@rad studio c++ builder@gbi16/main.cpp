...
void save_test_data(test_data_type* data, int len)
{
	test_data_type* d = &data [len -1];

	char cstr [1024];

	FILE* f  = NULL;

	f = fopen("test_data.csv", "wb");
	...
	sprintf(cstr, "Объект; Место; Дата; Направление; Позиция; X; Y; \r\n");

	fwrite(cstr, strlen(cstr), 1, f);

	sprintf(cstr, "Тестовый объект; Скважина 1; 05.05.2026  02:12:53;  Forward Start;  %.1fм ; %.2f ″; %.2f ; \r\n", d->dep, d->X1, d->Y1);
	fwrite(cstr, strlen(cstr), 1, f);

	for (int i = len - 2; i >= 0; i--) {

		d = &data [i];
		sprintf(cstr, "Тестовый объект; Скважина 1; 05.05.2026  02:12:53;  Forward;  %.1fм ; %.2f ″; %.2f ″; \r\n", d->dep, d->X1, d->Y1);
		fwrite(cstr, strlen(cstr), 1, f);
	...
	sprintf(cstr, "Тестовый объект; Скважина 1; 05.05.2026  02:12:53;  Back Start;  %.1fм ; %.2f ″; %.2f ″; \r\n", d->dep, d->X2, d->Y2);
	fwrite(cstr, strlen(cstr), 1, f);

	for (int i = len - 2; i >= 0; i--) {

		d = &data [i];
		sprintf(cstr, "Тестовый объект; Скважина 1; 05.05.2026  02:12:53;  Back;  %.1fм ; %.2f ″; %.2f ″; \r\n", d->dep, d->X2, d->Y2);
		fwrite(cstr, strlen(cstr), 1, f);
...
void __fastcall TFMain::ToolButton_testClick(TObject *Sender)
{
	...
	test_data_type test_data [] = {
		...
		{0,-1896.5,-5592.9,-937.8,3616.3},
		{0.5,-2364.2,-7831.4,-386.7,5773.3},
		{1,-3432.6,-7218.9,598.5,5387.3},
		{1.5,-4867.4,-6719.7,2158,4850.3},
		{2,-5311.3,-5929.4,2514.5,4084.5},
		{2.5,-5808.5,-5026.3,2923.5,3084.2},
		{3,-6555.7,-4151,3821.4,2276.9},
		{3.5,-7445.6,-3603.8,4826.1,1606.5},
		{4,-6909.9,-3436.8,3979,1518.5},
		{4.5,-5428.5,-3307.3,2629.4,1346.7},
		{5,-3640.7,-3557.9,903.9,1645.4},
		{5.5,-2168.3,-3645.9,-647.6,1688.3},
		{6,-1300.6,-3492.1,-1537.1,1533.1},
		{6.5,-759.2,-3390.2,-1852.9,1478.3},
		{7,-1359.7,-2851.9,-1589.2,900},
		{7.5,-754.9,-2219.4,-1915.7,328.5},
		{8,-379.2,-1805.8,-2592.9,-166.5},
		{8.5,178.5,-1423.2,-2872.6,-474},
		{9,423.2,-1137.1,-3310.5,-815.9},
		{9.5,491.2,-811.6,-3185.4,-1192.5},
		{10,-201.3,140.9,-2641.3,-1988.4},
		{10.5,295.3,14.9,-3192.4,-1955.9},
		{11,1545.3,386,-4267,-2284.8},
		{11.5,2871.2,918.7,-5580.9,-2792.9},
		{12,4022.4,1150.6,-6799,-3093.2},
		{39,1436.9,11957.5,-4032.4,-13922.5},
		{39.5,2188.6,12365.1,-5054.8,-14245.2},
		{40,1648.9,9415.2,-4563.5,-11380.6},
		{40.5,1991.3,9091.9,-4670.1,-11038.9},
		{41,1797.1,8123.7,-4891.8,-10047.2},
		{41.5,1839.1,7237.5,-4384.6,-9177.2},
		{42,1482.2,6226,-4388.9,-8129.7},
		{42.5,1180.9,5697.3,-4090.6,-7669.6},
		{43,-122.6,6873.6,-2727.2,-8776.1},
		{43.5,-1381.8,7627.2,-1256,-9617.1},
		{44,-2874.5,8510.7,-35.9,-10434.5},
		{44.5,-3932.9,9326.3,1217.2,-11284.6},
		{45,-4585.3,10224.3,1650.6,-12135.6},
		{45.5,-4160.6,11325.3,1491.8,-13281.6},
		{46,-1836.7,12264.4,-1114.9,-14303.8},
		{46.5,-896.6,13228.8,-1908.3,-15102},
		{47,141.6,13826.5,-2718.4,-15813.6},
		{47.5,978.6,14415.5,-3806.2,-16341.6},
		{48,1563.6,14321.1,-4467.5,-16203.6},
		{48.5,2123.1,13662.7,-5171.2,-15503.9},
		{49,1901.5,11801.1,-4561.9,-13723.5},
		{49.5,1834.6,10798.1,-4924.9,-12797.3},
		{50,1748.2,10177.4,-4558.4,-12074.1},
		{50.5,1392.9,9832.1,-4007.5,-11742.9},
		{51,725.8,9832.7,-3740.3,-11780.1},
		{51.5,865.8,10315.6,-3600.6,-12256.1},
		{52,906.2,8425.4,-3986.9,-10386.2},
		{52.5,727.8,8836,-3449,-10781.7},
		{53,541.9,8951.6,-3312.5,-10877.7},
		{53.5,512.3,8606.7,-3283.1,-10529.7},
		{54,520.4,8498.8,-3366.1,-10409.1},
		{54.5,765.7,8404.2,-3479,-10478.8},
		{55,1495.4,10884.4,-4373.5,-12797.4},
		{55.5,887.5,11037.8,-3617.3,-12979.4},
		{56,63.2,11088.1,-3071.8,-12996.4},
		{56.5,-153.2,11092.1,-2530.5,-13079.5},
		{57,-568.8,11106.6,-2286.7,-13049.6},
		{57.5,-362.3,11469.2,-2474.9,-13309.6},
		{58,526.1,11108.4,-3398.8,-13150.1},
		{58.5,708.5,11143,-3420.3,-13032.1},
		{59,695.3,11079.3,-3562.2,-13073.4},
		{59.5,563.5,11193.1,-3385.2,-13136.6},
		{60,431.7,11560.3,-3223.5,-13512.1},

	};


	save_test_data(test_data, 60/0.5 + 1);

    return;

	TPlace* p = GBISystem->place_list [0];
	TDrill* d = p->drill_list [0];
	TMeas* m = d->meas_list [0];

	for (int i = 0; i <m->records_cnt; i++) {

		m->records [i].depth = test_data [i].dep;

		m->records [i].X1 = test_data [i].X1;
		m->records [i].X2 = test_data [i].X2;
		m->records [i].Y1 = test_data [i].Y1;
		m->records [i].Y2 = test_data [i].Y2;
