...
#include "MeasChartThread.h"
#include "ComplexChartThread.h"
...
__published:	// IDE-managed Components
	...
	TTabSheet *TabSheet_report;
	TTabSheet *TabSheet_chart;
	TTabSheet *TabSheet_meas;
	TPanel *Panel_meas;
	TPanel *Panel1;
	TSplitter *Splitter3;
	TPanel *Panel3;
	TListView *ListView_meas;
	TChart *Chart_meas;
	TLineSeries *Series23;
	TLineSeries *Series24;
	TPanel *Panel_chart_complex;
	TPanel *Panel4;
	TListView *ListView_complex_table;
	TTabSheet *TabSheet_summary;
	TPanel *Panel6;
	TPanel *Panel_summary_table;
	TPanel *Panel_summary_chart;
	TSplitter *Splitter7;
	TListView *ListView_complex_data;
	TChart *Chart_complex;
	TTimer *Timer_start_main_wnd;
	TTimer *Timer_wait_report_create;
	...
	void __fastcall TreeView_systemKeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
	void __fastcall TreeView_systemKeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
	void __fastcall Chart_complexMouseMove(TObject *Sender, TShiftState Shift, int X,
          int Y);
	void __fastcall ListView_complex_dataMouseMove(TObject *Sender, TShiftState Shift,
          int X, int Y);
	void __fastcall Timer_start_main_wndTimer(TObject *Sender);
	void __fastcall ToolButton_testClick(TObject *Sender);
	void __fastcall Timer_wait_report_createTimer(TObject *Sender);
...
public:		// User declarations
	...
	void ShowChartHint_t(TChart* chart, int X, int Y);
};
//---------------------------------------------------------------------------
