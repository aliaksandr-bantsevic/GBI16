...
typedef struct {
	...
	double tempr [DATA_FILE_RECORD_CNT_MAX];

} data_file_meas_gtm_type;
...
typedef struct {
		...
		int idx;
		data_file_meas_gtm_type meas_gtm[ DATA_FILE_MEAS_CNT_MAX];

} data_file_meas_gtm_set_type;
...
public:
	...
	int GetWord_GTM(void);
	int AcceptDaTaFileMeas_GTM(void);
	void CopyDataFileMeas_GTM(data_file_meas_gtm_type* targ, data_file_meas_gtm_type* src);
	void ClearDataFileMeas_GTM(data_file_meas_gtm_type* targ);
...
public:
	...
	int data_file_record_cnt;

	/* GTM */
	data_file_meas_gtm_type data_file_meas_gtm;

	data_file_meas_gtm_set_type data_file_meas_gtm_set;
